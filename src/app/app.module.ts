...
import { ModalConfirmReturnDeviceComponent } from './components/modal-windows/modal-confirm-return-device/modal-confirm-return-device.component';
import { ModalDeviceCardComponent } from './components/modal-windows/modal-device-card/modal-device-card.component';
import { ModalCharacteristicDeviceComponent } from './components/modal-windows/modal-characteristic-device/modal-characteristic-device.component';
import { ModalUsageHistoryComponent } from './components/modal-windows/modal-usage-history/modal-usage-history.component';
import {ModalBookingHistoryComponent} from "./components/modal-windows/modal-booking-history/modal-booking-history.component";
import {ModalConfirmCancelReserveComponent} from "./components/modal-windows/modal-confirm-cancel-reserve/modal-confirm-cancel-reserve.component";
import {ModalBookingCardComponent} from "./components/modal-windows/modal-booking-card/modal-booking-card.component";
import {ModalSuccessBookingComponent} from "./components/modal-windows/modal-success-booking/modal-success-booking.component";
